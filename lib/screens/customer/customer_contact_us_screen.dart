...
class CustomerContactUsScreen extends StatefulWidget {
  final String userId;
  CustomerContactUsScreen({this.userId}): super();
  _CustomerContactUsScreenState createState() => _CustomerContactUsScreenState();
}

class _CustomerContactUsScreenState extends State<CustomerContactUsScreen>{
